...
public class MockSpotify implements MusicSource {
    ...
    static {
        ...
        public List<Album> albumOf (String id) throws Exception {
            ...
            //Recorremos los titulos de los albunes
        ...
        public List<Song> songOf (String id) throws Exception {
            ...
            String response = accessor.get("/artists/" + id + "/tracks/", Map.of());
            ...
            for (JsonElement item : items) {
                ...
                int duration = item.getAsJsonObject().get("duration").getAsInt();
